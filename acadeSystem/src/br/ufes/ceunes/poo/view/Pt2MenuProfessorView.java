...
public class Pt2MenuProfessorView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ACADEsYSTEM - Menu principal (Professor)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pt2MenuProfessorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pt2MenuProfessorView().setVisible(true);
            }
        });
    }
